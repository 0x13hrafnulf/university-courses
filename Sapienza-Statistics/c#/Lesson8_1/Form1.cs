...
namespace Lesson8_1
{
    public partial class Form1 : Form
    {
        ...
        private void init_graphics()
        {
            ...
            reg_plot = new RegressionPlot(3 * pictureBox1.Width / 9, 0, 5 * pictureBox1.Width / 9, pictureBox1.Height);
            ...
            histo2 = new Histogram(0, 0, 3 * pictureBox1.Width / 9, pictureBox1.Height/2);
            //histo2 = new Histogram(0, 0, 8 * pictureBox1.Width / 9, pictureBox1.Height);
            histo3 = new Histogram(0, pictureBox1.Height / 2, 3 * pictureBox1.Width / 9, pictureBox1.Height / 2);
        ...
        private void draw_scene()
        {
            ...
            histo2.draw(G, Data.m_intervals[1], 0, Color.FromArgb(255, 0, 0, 225));
            histo3.draw(G, Data.m_intervals[2], 0, Color.FromArgb(255, 128, 0, 0));
        ...
        private void generate_points()
        {
            ...
            Data.process_Poisson_intervals(time_index, intervals);
            Data.process_new_arrival(n_N/2);
            Data.process_consecutive_jumps(n_N/2);
        }
