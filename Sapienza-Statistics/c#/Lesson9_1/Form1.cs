    ...
    public partial class Form1 : Form
    {
        ...
        private void generate_points()
        {
            ...
            for (int i = 0; i < n_M; ++i)
            {
                ...
                {
                    double z = Z(rnd);
                    int val = (int)(sigma * Math.Sqrt(1.0 / n_N) * z);
                    val += v.get(j - 1);
                    v.Add(val);
                }

                Data.add_variable(n_N, v);
                Data.add_Brownian_datapoint(i, Color.FromArgb(rnd.Next(256), rnd.Next(256), rnd.Next(256)));

            }
            Data.process_Brownian_intervals(0, intervals);
            Data.process_Brownian_intervals(time_index, intervals);
        }
