...
int main(int argc, char **argv)
{
	...
	plane_material->set_emission_color(glm::vec4{ 0.1f, 0.1f, 0.1f, 1.0f });
	plane_material->set_specular_color(glm::vec3{ 0.332741f, 0.328634f, 0.346435f });
	plane_material->set_specular_exponent(38.4f);
	plane_material->set_diffuse_color(glm::vec4{ 0.18275f, 0.17f, 0.22525f, 1.0f });
	plane_material->set_ambient_color(glm::vec3{ 0.05375f, 0.05f, 0.06625f });
	...
	sphere->set_scale(glm::vec3{ 0.8f });
