...
int main(int argc, char **argv)
{
    ...
    std::shared_ptr<ES2Geometry> geometry = std::make_shared<ES2Geometry>(vertices);
	std::shared_ptr<ES2ConstantMaterial> material = std::make_shared<ES2ConstantMaterial>();
